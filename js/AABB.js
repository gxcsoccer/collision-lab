...
window.onload = function() {
	...
	function checkCollision(rect1, rect2) {
		if ((rect2.center.x + rect2.width / 2 < rect1.center.x - rect1.width / 2) || 
			(rect1.center.x + rect1.width / 2 < rect2.center.x -rect2.width / 2) || 
			(rect2.center.y + rect2.height / 2 < rect1.center.y - rect1.height / 2) || 
			(rect1.center.y + rect1.height / 2 < rect2.center.y - rect2.height / 2)) {
			return false;
		} else {
			return true;
		}
